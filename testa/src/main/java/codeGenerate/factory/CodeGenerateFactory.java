...
public class CodeGenerateFactory {
	...
	public static void codeGenerate(String tableName, String codeName, String entityPackage, String keyType, String pageFolder,
		...
		String junit = "junit\\" + entityPackage + "\\" + className + "Junit.java";
		...
		CommonPageParser.WriterPage(context, "MapperTemplate.xmltemp", pckPath, sqlMapperPath);
		CommonPageParser.WriterPage(context, "ControllerTemplate.ftl", pckPath, controllerPath);
		CommonPageParser.WriterPage(context, "ServiceJunitTemplate.ftl", pckPath, junit);
